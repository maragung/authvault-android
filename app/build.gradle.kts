...
android {
    namespace = "auth.vault"
    compileSdk = 36

    defaultConfig {
        applicationId = "auth.vault"
        minSdk = 31
        targetSdk = 36
        versionCode = 1
        versionName = "1.0.0"
    ...
    signingConfigs {
        create("release") {
            ...
            storePassword = System.getenv("KEYSTORE_PASSWORD") ?: "authvault"
            keyAlias = System.getenv("KEY_ALIAS") ?: "authvault"
            keyPassword = System.getenv("KEY_PASSWORD") ?: "authvault"
        }
    }
